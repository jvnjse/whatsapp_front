...
function Plan() {
    ...
    return (
        <div className=' w-screen h-[100%] overflow-hidden '>
                ...
                <div className='flex justify-center w-full gap-4 max-sm:text-xs max-sm:gap-4 flex-wrap flex-1' >
                    <div className='bg-white p-4 px-16 flex flex-col items-center justify-between gap-3 rounded-xl pt-16 plan-box w-[300px] '>
                        <ul className='flex items-center flex-col whitespace-nowrap gap-4 text-xs '>
                            ...
                            <div className=' text-2xl font-extrabold mt-5 whitespace-nowrap '>&#x20B9; 999</div>
                            <div className=' text-2xl font-bold  whitespace-nowrap '>Basic Plan</div>
                    ...
                    <div className='bg-white p-4 px-16 flex flex-col items-center justify-between gap-3 rounded-xl pt-16 plan-box w-[300px]'>
                        <ul className='flex items-center flex-col whitespace-nowrap gap-2 text-xs'>
                            ...
                            <div className=' text-2xl font-extrabold mt-5 whitespace-nowrap '>&#x20B9; 1999</div>
                            <div className=' text-2xl font-bold whitespace-nowrap '>Standard Plan</div>
                            <li className='flex gap-2'><BsStars />Unlimited agent logins</li>
                            <li className='flex gap-2'><BsStars />Template message APIs</li>
                            <li className='flex gap-2'><BsStars />Send bulk text message directly from pc</li>
            ...
            <section id='calculator' className='flex flex-col justify-center items-center gap-7 w-full text-center bg-[#afd5be] py-10 px-28 max-sm:px-4'>
                <h2 className=' font-bold text-5xl p-5 px-20 leading-snug  text-[#221231] max-md:p-1 max-md:text-3xl max-sm:text-lg'>Meta Messaging Calculator</h2>
                <div className='flex flex-col items-center w-full gap-4 max-sm:text-xs max-sm:gap-4 flex-wrap flex-1 bg-white rounded-xl p-7' >
                    <span className="accordion-button">
                        <div className='flex flex-col gap-4'>
                            <p className="text-3xl text-[#221231] font-bold">Marketing Messages</p>
                            <p className="copy-small accordion-subtitle">
                                <span className=" text-2xl font-semibold">{numberValue}</span> Messages = <span className="text-2xl font-semibold">&#x20B9; {amount}</span>
                            </p>
